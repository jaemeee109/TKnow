...
public class MemberServiceImpl implements MemberService {
	...
	public MemberResponseDTO createMember(MemberCreateRequestDTO req) {
		...
		vo.setMemberSex(req.getMemberSex());
		
		// 기존 createMember() 안에서 VO 세팅 부분만
		String sex = "U"; // Unknown 기본값
		if (req.getMemberSex() != null) {
		    if (req.getMemberSex().equalsIgnoreCase("male")) sex = "M";
		    else if (req.getMemberSex().equalsIgnoreCase("female")) sex = "F";
		}
		vo.setMemberSex(sex);
